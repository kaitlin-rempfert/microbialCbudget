...
g1<- ggplot(data=Folch_frac_1, aes(x=mean.wt.perc, xmin = mean.wt.perc - sd.wt.perc, xmax = mean.wt.perc + sd.wt.perc, y = Group2, fill=Type))
...
colorpallete2 <- c("orange", "purple", "#007308","grey", "chocolate4")
